...
import de.gematik.openhealth.crypto.internal.interop.AesCipher as WasmAesCipher
...
private class JsAesCipher(
    ...
    private val cipher by lazyDeferred<WasmAesCipher> {
    ...
    override fun final(): ByteArray =
        runWithProvider {
            cipher.final().alsoDefer().toByteArray()
        }
