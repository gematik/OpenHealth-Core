...
private class JsEcPoint(
    ...
    fun plus(other: JsEcPoint): EcPoint =
        runWithProvider {
...
internal actual fun EcPoint.nativeTimes(k: BigInteger): EcPoint =
    JsEcPoint(curve, uncompressed).times(k)

internal actual fun EcPoint.nativePlus(other: EcPoint): EcPoint =
    JsEcPoint(curve, uncompressed).plus(JsEcPoint(other.curve, other.uncompressed))
