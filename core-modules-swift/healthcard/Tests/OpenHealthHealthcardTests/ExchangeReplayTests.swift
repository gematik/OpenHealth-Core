...
final class ExchangeReplayTests: XCTestCase {
    func testReplayEstablishSecureChannel() throws {
        let transcript = try transcriptFromJsonl(JSONL_ESTABLISH_SECURE_CHANNEL)
        _ = try establishReplaySecureChannel(transcript: transcript)
    }

    func testReplayVerifyPin() throws {
        let transcript = try transcriptFromJsonl(JSONL_VERIFY_PIN)
    ...
    func testReplayGetRandom() throws {
        let transcript = try transcriptFromJsonl(JSONL_GET_RANDOM)
        let secureChannel = try establishReplaySecureChannel(transcript: transcript)
    ...
    func testReplayReadVsd() throws {
        let transcript = try transcriptFromJsonl(JSONL_READ_VSD)
        let secureChannel = try establishReplaySecureChannel(transcript: transcript)
    ...
    func testReplayRetrieveCertificates() throws {
        let transcript = try transcriptFromJsonl(JSONL_READ_CERTS)
        let secureChannel = try establishReplaySecureChannel(transcript: transcript)
...
private let JSONL_ESTABLISH_SECURE_CHANNEL = """
{"type":"header","version":1,"supports_extended_length":true,"keys":["99472E124DE0FC6E4D80C797FAB3E512CD70351F521DE5556AD4FB7491911BF7","7C33C0F7883452F90759A14EECEBEDA9890DD20304680372FE85EF7E67A80B45"],"can":"123123"}
...
private let JSONL_VERIFY_PIN = """
{"type":"header","version":1,"supports_extended_length":true,"keys":["93375C287BD80A761F420E43454176A998FB9A97DEA5A7502707C21503F1A765","3323B2073BE0658E0F6E697A3B2B2AA0FAA0B743996A22D7DB38ADE47CD7828B"],"can":"123123"}
{"type":"exchange","tx":"00A4040400","rx":""}
{"type":"exchange","tx":"00B09100000000","rx":"EF2BC003020000C103040502C210545359534954434F5345433230020400C403010000C503020000C7030100009000"}
{"type":"exchange","tx":"00A4020C02011C","rx":"9000"}
{"type":"exchange","tx":"00B00000000000","rx":"31143012060A04007F0007020204020202010202010D9000"}
...
private let JSONL_GET_RANDOM = """
{"type":"header","version":1,"supports_extended_length":true,"keys":["178408E6CBC3C9C43848E6C6D797D9B5CC7ADA2426C566BF8EA85B6BC2400063","834E7850F1A56BF91EED9F3937E7A2B331FC3402F5A92C05D50CEEA9E0B7C866"],"can":"123123"}
{"type":"exchange","tx":"00A4040400","rx":""}
{"type":"exchange","tx":"00B09100000000","rx":"EF2BC003020000C103040502C210545359534954434F5345433230020400C403010000C503020000C7030100009000"}
{"type":"exchange","tx":"00A4020C02011C","rx":"9000"}
{"type":"exchange","tx":"00B00000000000","rx":"31143012060A04007F0007020204020202010202010D9000"}
...
private let JSONL_READ_VSD = """
{"type":"header","version":1,"supports_extended_length":true,"keys":["0FB961D0B3F14EB4C97C5D3818D1217DF815BB76DBE086DEE61B6073E935F1A4","6B4FD168C9113727ABEDF35664C474F716A6A3F2916C2466D02D0F73D044D1D4"],"can":"123123"}
{"type":"exchange","tx":"00A4040400","rx":""}
{"type":"exchange","tx":"00B09100000000","rx":"EF2BC003020000C103040502C210545359534954434F5345433230020400C403010000C503020000C7030100009000"}
{"type":"exchange","tx":"00A4020C02011C","rx":"9000"}
{"type":"exchange","tx":"00B00000000000","rx":"31143012060A04007F0007020204020202010202010D9000"}
...
private let JSONL_READ_CERTS = """
{"type":"header","version":1,"supports_extended_length":true,"keys":["4D5F4BFF85CA50E39F0114EF2435DB775FC8868B43626A8CCDD615CCF3282F73","2C083AE5324DD03C85D0D3F383BFEFE0572CA8DD1257BABBEB07EC78F7291411"],"can":"123123"}
{"type":"exchange","tx":"00A4040400","rx":""}
{"type":"exchange","tx":"00B09100000000","rx":"EF2BC003020000C103040502C210545359534954434F5345433230020400C403010000C503020000C7030100009000"}
{"type":"exchange","tx":"00A4020C02011C","rx":"9000"}
{"type":"exchange","tx":"00B00000000000","rx":"31143012060A04007F0007020204020202010202010D9000"}
