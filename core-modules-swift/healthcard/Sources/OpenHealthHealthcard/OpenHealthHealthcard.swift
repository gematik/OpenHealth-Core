...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_openhealth_healthcard_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_openhealth_healthcard_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureOpenhealthHealthcardInitialized()
...
open class CardAccessNumber: CardAccessNumberProtocol, @unchecked Sendable {
    ...
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_openhealth_healthcard_fn_clone_cardaccessnumber(self.handle, $0) }
    }
    // No primary constructor declared for this class.

    deinit {
        try! rustCall { uniffi_openhealth_healthcard_fn_free_cardaccessnumber(handle, $0) }
    }
...
public static func fromDigits(digits: String)throws  -> CardAccessNumber  {
    ...
    uniffi_openhealth_healthcard_fn_constructor_cardaccessnumber_from_digits(
...
open func digits() -> String  {
    ...
    uniffi_openhealth_healthcard_fn_method_cardaccessnumber_digits(
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_openhealth_healthcard_fn_clone_cardchannel(self.handle, $0) }
    }
    // No primary constructor declared for this class.

    deinit {
        try! rustCall { uniffi_openhealth_healthcard_fn_free_cardchannel(handle, $0) }
    }
...
open func supportsExtendedLength() -> Bool  {
    ...
    uniffi_openhealth_healthcard_fn_method_cardchannel_supports_extended_length(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func transmit(command: CommandApdu)throws  -> ResponseApdu  {
    ...
    uniffi_openhealth_healthcard_fn_method_cardchannel_transmit(
...
private func uniffiCallbackInitCardChannel() {
    uniffi_openhealth_healthcard_fn_init_callback_vtable_cardchannel(UniffiCallbackInterfaceCardChannel.vtable)
}
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_openhealth_healthcard_fn_clone_cardpin(self.handle, $0) }
    }
    // No primary constructor declared for this class.

    deinit {
        try! rustCall { uniffi_openhealth_healthcard_fn_free_cardpin(handle, $0) }
    }
...
public static func fromDigits(digits: String)throws  -> CardPin  {
    ...
    uniffi_openhealth_healthcard_fn_constructor_cardpin_from_digits(
        FfiConverterString.lower(digits),$0
    )
})
}
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_openhealth_healthcard_fn_clone_commandapdu(self.handle, $0) }
    }
    // No primary constructor declared for this class.

    deinit {
        try! rustCall { uniffi_openhealth_healthcard_fn_free_commandapdu(handle, $0) }
    }
...
public static func fromBytes(bytes: Data)throws  -> CommandApdu  {
    ...
    uniffi_openhealth_healthcard_fn_constructor_commandapdu_from_bytes(
     ...
     */
public static func headerOnly(cla: Int32, ins: Int32, p1: Int32, p2: Int32)throws  -> CommandApdu  {
    return try  FfiConverterTypeCommandApdu_lift(try rustCallWithError(FfiConverterTypeApduError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_commandapdu_header_only(
        FfiConverterInt32.lower(cla),
        FfiConverterInt32.lower(ins),
        FfiConverterInt32.lower(p1),
        FfiConverterInt32.lower(p2),$0
    )
})
}
     ...
     */
public static func withData(cla: Int32, ins: Int32, p1: Int32, p2: Int32, lengthClass: LengthClass, data: Data)throws  -> CommandApdu  {
    return try  FfiConverterTypeCommandApdu_lift(try rustCallWithError(FfiConverterTypeApduError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_commandapdu_with_data(
        FfiConverterInt32.lower(cla),
        FfiConverterInt32.lower(ins),
        FfiConverterInt32.lower(p1),
        FfiConverterInt32.lower(p2),
     ...
     */
public static func withDataAndExpect(cla: Int32, ins: Int32, p1: Int32, p2: Int32, lengthClass: LengthClass, data: Data, expectedLength: Int32)throws  -> CommandApdu  {
    return try  FfiConverterTypeCommandApdu_lift(try rustCallWithError(FfiConverterTypeApduError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_commandapdu_with_data_and_expect(
        FfiConverterInt32.lower(cla),
        FfiConverterInt32.lower(ins),
        FfiConverterInt32.lower(p1),
        FfiConverterInt32.lower(p2),
        ...
        FfiConverterInt32.lower(expectedLength),$0
    )
})
}
     ...
     */
public static func withExpect(cla: Int32, ins: Int32, p1: Int32, p2: Int32, lengthClass: LengthClass, expectedLength: Int32)throws  -> CommandApdu  {
    return try  FfiConverterTypeCommandApdu_lift(try rustCallWithError(FfiConverterTypeApduError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_commandapdu_with_expect(
        FfiConverterInt32.lower(cla),
        FfiConverterInt32.lower(ins),
        FfiConverterInt32.lower(p1),
        FfiConverterInt32.lower(p2),
...
open func toVec() -> VecOfU8  {
    return try!  FfiConverterTypeVecOfU8_lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_commandapdu_to_vec(
            self.uniffiCloneHandle(),$0
    )
})
}
 ...
 */
public protocol HealthCardCommandProtocol: AnyObject, Sendable {
    
    /**
     * Executes the command on the given card channel and returns the mapped response.
     */
    func execute(session: CardChannel) throws  -> HealthCardResponse
    
    /**
     * Maps a status word to the expected response status for this command.
     */
    func mapStatus(sw: Int32) throws  -> HealthCardResponseStatus
    
    /**
     * Encodes the command into a command APDU.
     */
    func toApdu(supportsExtendedLength: Bool) throws  -> CommandApdu
    
}
/**
 * FFI wrapper for `HealthCardCommand`.
 */
open class HealthCardCommand: HealthCardCommandProtocol, @unchecked Sendable {
    fileprivate let handle: UInt64
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_openhealth_healthcard_fn_clone_healthcardcommand(self.handle, $0) }
    }
    // No primary constructor declared for this class.

    deinit {
        try! rustCall { uniffi_openhealth_healthcard_fn_free_healthcardcommand(handle, $0) }
    }
     ...
     */
public static func changeReferenceData(passwordId: Int32, dfSpecific: Bool, oldSecret: Data, newSecret: Data)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_change_reference_data(
        FfiConverterInt32.lower(passwordId),
        FfiConverterBool.lower(dfSpecific),
        FfiConverterData.lower(oldSecret),
        FfiConverterData.lower(newSecret),$0
    )
})
}
     ...
     */
public static func generalAuthenticate(commandChaining: Bool)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_general_authenticate(
        FfiConverterBool.lower(commandChaining),$0
    )
})
}
     ...
     */
public static func generalAuthenticateElcStep2(ephemeralPkOpponent: Data)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_general_authenticate_elc_step2(
        FfiConverterData.lower(ephemeralPkOpponent),$0
    )
})
}
     ...
     */
public static func generalAuthenticateMutualAuthenticationStep1(keyRef: Data)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_general_authenticate_mutual_authentication_step1(
        FfiConverterData.lower(keyRef),$0
    )
})
}
     ...
     */
public static func generalAuthenticateWithData(commandChaining: Bool, data: Data, tagNo: Int32)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_general_authenticate_with_data(
        FfiConverterBool.lower(commandChaining),
        FfiConverterData.lower(data),
        FfiConverterInt32.lower(tagNo),$0
    )
})
}
     ...
     */
public static func getPinStatus(passwordId: Int32, dfSpecific: Bool)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_get_pin_status(
        FfiConverterInt32.lower(passwordId),
        FfiConverterBool.lower(dfSpecific),$0
    )
})
}
     ...
     */
public static func getRandomValues(length: Int32)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_get_random_values(
        FfiConverterInt32.lower(length),$0
    )
})
}
     ...
     */
public static func internalAuthenticate(challenge: Data) -> HealthCardCommand  {
    return try!  FfiConverterTypeHealthCardCommand_lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_internal_authenticate(
...
public static func listPublicKeys() -> HealthCardCommand  {
    return try!  FfiConverterTypeHealthCardCommand_lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_list_public_keys($0
    )
})
}
     ...
     */
public static func manageSecEnvForSigning(psoAlgorithm: PsoAlgorithm, keyId: Int32, dfSpecific: Bool)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_manage_sec_env_for_signing(
        FfiConverterTypePsoAlgorithm_lower(psoAlgorithm),
        FfiConverterInt32.lower(keyId),
        FfiConverterBool.lower(dfSpecific),$0
    )
})
}
     ...
     */
public static func manageSecEnvForVerifyCertificate(car: Data)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_manage_sec_env_for_verify_certificate(
        FfiConverterData.lower(car),$0
    )
})
}
     ...
     */
public static func manageSecEnvSelectPrivateKey(keyRef: Int32, algorithmId: Int32)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_manage_sec_env_select_private_key(
        FfiConverterInt32.lower(keyRef),
        FfiConverterInt32.lower(algorithmId),$0
    )
})
}
     ...
     */
public static func manageSecEnvSetSignatureKeyReference(keyRef: Data)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_manage_sec_env_set_signature_key_reference(
        FfiConverterData.lower(keyRef),$0
    )
})
}
     ...
     */
public static func manageSecEnvWithoutCurves(passwordId: Int32, dfSpecific: Bool, oid: Data)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_manage_sec_env_without_curves(
        FfiConverterInt32.lower(passwordId),
        FfiConverterBool.lower(dfSpecific),
        FfiConverterData.lower(oid),$0
    )
})
}
     ...
     */
public static func psoComputeDigitalSignature(dataToBeSigned: Data) -> HealthCardCommand  {
    return try!  FfiConverterTypeHealthCardCommand_lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_pso_compute_digital_signature(
        FfiConverterData.lower(dataToBeSigned),$0
    )
})
}
     ...
     */
public static func psoComputeDigitalSignatureCvc(dataToBeSigned: Data) -> HealthCardCommand  {
    return try!  FfiConverterTypeHealthCardCommand_lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_pso_compute_digital_signature_cvc(
        FfiConverterData.lower(dataToBeSigned),$0
    )
})
}
     ...
     */
public static func read()throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_read($0
    )
})
}
     ...
     */
public static func readSfi(sfi: Int32)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_read_sfi(
        FfiConverterInt32.lower(sfi),$0
    )
})
}
     ...
     */
public static func readSfiWithOffset(sfi: Int32, offset: Int32)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_read_sfi_with_offset(
        FfiConverterInt32.lower(sfi),
        FfiConverterInt32.lower(offset),$0
    )
})
}
     ...
     */
public static func readSfiWithOffsetAndLength(sfi: Int32, offset: Int32, expectedLength: Int32)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_read_sfi_with_offset_and_length(
        FfiConverterInt32.lower(sfi),
     ...
     */
public static func readWithOffset(offset: Int32)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_read_with_offset(
        FfiConverterInt32.lower(offset),$0
    )
})
}
     ...
     */
public static func readWithOffsetAndLength(offset: Int32, expectedLength: Int32)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_read_with_offset_and_length(
        FfiConverterInt32.lower(offset),
        FfiConverterInt32.lower(expectedLength),$0
    )
})
     ...
     */
public static func resetRetryCounter(passwordId: Int32, dfSpecific: Bool, puk: Data)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_reset_retry_counter(
        FfiConverterInt32.lower(passwordId),
        FfiConverterBool.lower(dfSpecific),
        FfiConverterData.lower(puk),$0
    )
})
}
     ...
     */
public static func resetRetryCounterWithNewSecret(passwordId: Int32, dfSpecific: Bool, puk: Data, newSecret: Data)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_reset_retry_counter_with_new_secret(
        FfiConverterInt32.lower(passwordId),
        FfiConverterBool.lower(dfSpecific),
        FfiConverterData.lower(puk),
        FfiConverterData.lower(newSecret),$0
    )
})
}
     ...
     */
public static func select(selectParentElseRoot: Bool, readFirst: Bool) -> HealthCardCommand  {
    return try!  FfiConverterTypeHealthCardCommand_lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_select(
        FfiConverterBool.lower(selectParentElseRoot),
        FfiConverterBool.lower(readFirst),$0
    )
})
}
     ...
     */
public static func selectAid(aid: Data)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_select_aid(
        FfiConverterData.lower(aid),$0
    )
})
}
     ...
     */
public static func selectAidWithOptions(aid: Data, selectNextElseFirstOccurrence: Bool, requestFcp: Bool, fcpLength: Int32)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_select_aid_with_options(
        FfiConverterData.lower(aid),
        FfiConverterBool.lower(selectNextElseFirstOccurrence),
        FfiConverterBool.lower(requestFcp),
        FfiConverterInt32.lower(fcpLength),$0
    )
})
}
     ...
     */
public static func selectFid(fid: Int32, selectDfElseEf: Bool)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_select_fid(
        FfiConverterInt32.lower(fid),
        FfiConverterBool.lower(selectDfElseEf),$0
    )
})
}
     ...
     */
public static func selectFidWithOptions(fid: Int32, selectDfElseEf: Bool, requestFcp: Bool, fcpLength: Int32)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_select_fid_with_options(
        FfiConverterInt32.lower(fid),
        FfiConverterBool.lower(selectDfElseEf),
        FfiConverterBool.lower(requestFcp),
        FfiConverterInt32.lower(fcpLength),$0
    )
})
     ...
     */
public static func verifyPin(passwordId: Int32, dfSpecific: Bool, encryptedPin: Data)throws  -> HealthCardCommand  {
    return try  FfiConverterTypeHealthCardCommand_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_healthcardcommand_verify_pin(
        FfiConverterInt32.lower(passwordId),
        FfiConverterBool.lower(dfSpecific),
        FfiConverterData.lower(encryptedPin),$0
    )
})
}
     ...
     * Executes the command on the given card channel and returns the mapped response.
     */
open func execute(session: CardChannel)throws  -> HealthCardResponse  {
    return try  FfiConverterTypeHealthCardResponse_lift(try rustCallWithError(FfiConverterTypeExchangeError_lift) {
    uniffi_openhealth_healthcard_fn_method_healthcardcommand_execute(
            self.uniffiCloneHandle(),
     ...
     * Maps a status word to the expected response status for this command.
     */
open func mapStatus(sw: Int32)throws  -> HealthCardResponseStatus  {
    return try  FfiConverterTypeHealthCardResponseStatus_lift(try rustCallWithError(FfiConverterTypeCommandBuilderError_lift) {
    uniffi_openhealth_healthcard_fn_method_healthcardcommand_map_status(
            self.uniffiCloneHandle(),
        FfiConverterInt32.lower(sw),$0
    )
})
}
     ...
     * Encodes the command into a command APDU.
     */
open func toApdu(supportsExtendedLength: Bool)throws  -> CommandApdu  {
    return try  FfiConverterTypeCommandApdu_lift(try rustCallWithError(FfiConverterTypeApduError_lift) {
    uniffi_openhealth_healthcard_fn_method_healthcardcommand_to_apdu(
            self.uniffiCloneHandle(),
        FfiConverterBool.lower(supportsExtendedLength),$0
    )
})
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeHealthCardCommand: FfiConverter {
    typealias FfiType = UInt64
    typealias SwiftType = HealthCardCommand

    public static func lift(_ handle: UInt64) throws -> HealthCardCommand {
        return HealthCardCommand(unsafeFromHandle: handle)
    }

    public static func lower(_ value: HealthCardCommand) -> UInt64 {
        return value.uniffiCloneHandle()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> HealthCardCommand {
        let handle: UInt64 = try readInt(&buf)
        return try lift(handle)
    }

    public static func write(_ value: HealthCardCommand, into buf: inout [UInt8]) {
        writeInt(&buf, lower(value))
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeHealthCardCommand_lift(_ handle: UInt64) throws -> HealthCardCommand {
    return try FfiConverterTypeHealthCardCommand.lift(handle)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeHealthCardCommand_lower(_ value: HealthCardCommand) -> UInt64 {
    return FfiConverterTypeHealthCardCommand.lower(value)
}
 ...
 */
public protocol HealthCardVersion2Protocol: AnyObject, Sendable {
    
    func fillingInstructionsAtrVersion()  -> Data
    
    func fillingInstructionsEnvironmentSettingsVersion()  -> Data
    
    func fillingInstructionsGdoVersion()  -> Data
    
    func fillingInstructionsKeyInfoVersion()  -> Data
    
    func fillingInstructionsLoggingVersion()  -> Data
    
    func fillingInstructionsVersion()  -> Data
    
    func isHealthCardVersion21()  -> Bool
    
    func objectSystemVersion()  -> Data
    
    func productIdentificationObjectSystemVersion()  -> Data
    
}
/**
 * Parsed content of `EF.Version2`.
 */
open class HealthCardVersion2: HealthCardVersion2Protocol, @unchecked Sendable {
    fileprivate let handle: UInt64
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_openhealth_healthcard_fn_clone_healthcardversion2(self.handle, $0) }
    }
    // No primary constructor declared for this class.

    deinit {
        try! rustCall { uniffi_openhealth_healthcard_fn_free_healthcardversion2(handle, $0) }
    }

    

    
open func fillingInstructionsAtrVersion() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_healthcardversion2_filling_instructions_atr_version(
            self.uniffiCloneHandle(),$0
    )
})
}
    
open func fillingInstructionsEnvironmentSettingsVersion() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_healthcardversion2_filling_instructions_environment_settings_version(
            self.uniffiCloneHandle(),$0
    )
})
}
    
open func fillingInstructionsGdoVersion() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_healthcardversion2_filling_instructions_gdo_version(
            self.uniffiCloneHandle(),$0
    )
})
}
    
open func fillingInstructionsKeyInfoVersion() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_healthcardversion2_filling_instructions_key_info_version(
            self.uniffiCloneHandle(),$0
    )
})
}
    
open func fillingInstructionsLoggingVersion() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_healthcardversion2_filling_instructions_logging_version(
            self.uniffiCloneHandle(),$0
    )
})
}
    
open func fillingInstructionsVersion() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_healthcardversion2_filling_instructions_version(
            self.uniffiCloneHandle(),$0
    )
})
}
    
open func isHealthCardVersion21() -> Bool  {
    return try!  FfiConverterBool.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_healthcardversion2_is_health_card_version_21(
            self.uniffiCloneHandle(),$0
    )
})
}
    
open func objectSystemVersion() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_healthcardversion2_object_system_version(
            self.uniffiCloneHandle(),$0
    )
})
}
    
open func productIdentificationObjectSystemVersion() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_healthcardversion2_product_identification_object_system_version(
            self.uniffiCloneHandle(),$0
    )
})
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeHealthCardVersion2: FfiConverter {
    typealias FfiType = UInt64
    typealias SwiftType = HealthCardVersion2

    public static func lift(_ handle: UInt64) throws -> HealthCardVersion2 {
        return HealthCardVersion2(unsafeFromHandle: handle)
    }

    public static func lower(_ value: HealthCardVersion2) -> UInt64 {
        return value.uniffiCloneHandle()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> HealthCardVersion2 {
        let handle: UInt64 = try readInt(&buf)
        return try lift(handle)
    }

    public static func write(_ value: HealthCardVersion2, into buf: inout [UInt8]) {
        writeInt(&buf, lower(value))
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeHealthCardVersion2_lift(_ handle: UInt64) throws -> HealthCardVersion2 {
    return try FfiConverterTypeHealthCardVersion2.lift(handle)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeHealthCardVersion2_lower(_ value: HealthCardVersion2) -> UInt64 {
    return FfiConverterTypeHealthCardVersion2.lower(value)
}
 ...
 */
public protocol ListPublicKeyEntryProtocol: AnyObject, Sendable {
    
    func applicationIdentifier()  -> Data
    
    func keyReference()  -> Data
    
}
/**
 * One parsed LIST PUBLIC KEY entry.
 */
open class ListPublicKeyEntry: ListPublicKeyEntryProtocol, @unchecked Sendable {
    fileprivate let handle: UInt64
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_openhealth_healthcard_fn_clone_listpublickeyentry(self.handle, $0) }
    }
    // No primary constructor declared for this class.

    deinit {
        try! rustCall { uniffi_openhealth_healthcard_fn_free_listpublickeyentry(handle, $0) }
    }

    

    
open func applicationIdentifier() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_listpublickeyentry_application_identifier(
            self.uniffiCloneHandle(),$0
    )
})
}
    
open func keyReference() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_listpublickeyentry_key_reference(
            self.uniffiCloneHandle(),$0
    )
})
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeListPublicKeyEntry: FfiConverter {
    typealias FfiType = UInt64
    typealias SwiftType = ListPublicKeyEntry

    public static func lift(_ handle: UInt64) throws -> ListPublicKeyEntry {
        return ListPublicKeyEntry(unsafeFromHandle: handle)
    }

    public static func lower(_ value: ListPublicKeyEntry) -> UInt64 {
        return value.uniffiCloneHandle()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ListPublicKeyEntry {
        let handle: UInt64 = try readInt(&buf)
        return try lift(handle)
    }

    public static func write(_ value: ListPublicKeyEntry, into buf: inout [UInt8]) {
        writeInt(&buf, lower(value))
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeListPublicKeyEntry_lift(_ handle: UInt64) throws -> ListPublicKeyEntry {
    return try FfiConverterTypeListPublicKeyEntry.lift(handle)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeListPublicKeyEntry_lower(_ value: ListPublicKeyEntry) -> UInt64 {
    return FfiConverterTypeListPublicKeyEntry.lower(value)
}
 ...
 */
public protocol ListPublicKeysProtocol: AnyObject, Sendable {
    
    func entries()  -> [ListPublicKeyEntry]
    
    func keyReferencesForApplicationIdentifier(applicationIdentifier: Data)  -> [Data]
    
}
/**
 * Parsed LIST PUBLIC KEY response.
 */
open class ListPublicKeys: ListPublicKeysProtocol, @unchecked Sendable {
    fileprivate let handle: UInt64
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_openhealth_healthcard_fn_clone_listpublickeys(self.handle, $0) }
    }
    // No primary constructor declared for this class.

    deinit {
        try! rustCall { uniffi_openhealth_healthcard_fn_free_listpublickeys(handle, $0) }
    }

    

    
open func entries() -> [ListPublicKeyEntry]  {
    return try!  FfiConverterSequenceTypeListPublicKeyEntry.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_listpublickeys_entries(
            self.uniffiCloneHandle(),$0
    )
})
}
    
open func keyReferencesForApplicationIdentifier(applicationIdentifier: Data) -> [Data]  {
    return try!  FfiConverterSequenceData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_listpublickeys_key_references_for_application_identifier(
            self.uniffiCloneHandle(),
        FfiConverterData.lower(applicationIdentifier),$0
    )
})
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeListPublicKeys: FfiConverter {
    typealias FfiType = UInt64
    typealias SwiftType = ListPublicKeys

    public static func lift(_ handle: UInt64) throws -> ListPublicKeys {
        return ListPublicKeys(unsafeFromHandle: handle)
    }

    public static func lower(_ value: ListPublicKeys) -> UInt64 {
        return value.uniffiCloneHandle()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ListPublicKeys {
        let handle: UInt64 = try readInt(&buf)
        return try lift(handle)
    }

    public static func write(_ value: ListPublicKeys, into buf: inout [UInt8]) {
        writeInt(&buf, lower(value))
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeListPublicKeys_lift(_ handle: UInt64) throws -> ListPublicKeys {
    return try FfiConverterTypeListPublicKeys.lift(handle)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeListPublicKeys_lower(_ value: ListPublicKeys) -> UInt64 {
    return FfiConverterTypeListPublicKeys.lower(value)
}
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_openhealth_healthcard_fn_clone_responseapdu(self.handle, $0) }
    }
    // No primary constructor declared for this class.

    deinit {
        try! rustCall { uniffi_openhealth_healthcard_fn_free_responseapdu(handle, $0) }
    }
...
public static func fromBytes(bytes: Data)throws  -> ResponseApdu  {
    ...
    uniffi_openhealth_healthcard_fn_constructor_responseapdu_from_bytes(
        FfiConverterData.lower(bytes),$0
    )
})
}
     ...
     */
public static func fromParts(sw: Int32, data: Data)throws  -> ResponseApdu  {
    return try  FfiConverterTypeResponseApdu_lift(try rustCallWithError(FfiConverterTypeApduError_lift) {
    uniffi_openhealth_healthcard_fn_constructor_responseapdu_from_parts(
        FfiConverterInt32.lower(sw),
        FfiConverterData.lower(data),$0
    )
})
}
...
open func data() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_responseapdu_data(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func sw() -> Int32  {
    ...
    uniffi_openhealth_healthcard_fn_method_responseapdu_sw(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func toVec() -> VecOfU8  {
    return try!  FfiConverterTypeVecOfU8_lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_responseapdu_to_vec(
            self.uniffiCloneHandle(),$0
    )
})
}
...
public protocol SecureChannelProtocol: AnyObject, Sendable {
     ...
     */
    func getRandom(length: Int32) throws  -> Data
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_openhealth_healthcard_fn_clone_securechannel(self.handle, $0) }
    }
    // No primary constructor declared for this class.

    deinit {
        try! rustCall { uniffi_openhealth_healthcard_fn_free_securechannel(handle, $0) }
    }
...
open func changePin(oldPin: CardPin, newPin: CardPin)throws  -> HealthCardResponseStatus  {
    ...
    uniffi_openhealth_healthcard_fn_method_securechannel_change_pin(
            self.uniffiCloneHandle(),
...
open func changePinWithPuk(puk: CardPin, newPin: CardPin)throws  -> HealthCardResponseStatus  {
    return try  FfiConverterTypeHealthCardResponseStatus_lift(try rustCallWithError(FfiConverterTypeSecureChannelError_lift) {
    uniffi_openhealth_healthcard_fn_method_securechannel_change_pin_with_puk(
            self.uniffiCloneHandle(),
     ...
     * Returns `length` bytes of random data from the card.
     */
open func getRandom(length: Int32)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeSecureChannelError_lift) {
    uniffi_openhealth_healthcard_fn_method_securechannel_get_random(
            self.uniffiCloneHandle(),
        FfiConverterInt32.lower(length),$0
    )
})
...
open func readVsd()throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeSecureChannelError_lift) {
    uniffi_openhealth_healthcard_fn_method_securechannel_read_vsd(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func retrieveCertificate()throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeSecureChannelError_lift) {
    uniffi_openhealth_healthcard_fn_method_securechannel_retrieve_certificate(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func retrieveCertificateFrom(certificate: CertificateFile)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeSecureChannelError_lift) {
    uniffi_openhealth_healthcard_fn_method_securechannel_retrieve_certificate_from(
            self.uniffiCloneHandle(),
...
open func signChallenge(challenge: Data)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeSecureChannelError_lift) {
    uniffi_openhealth_healthcard_fn_method_securechannel_sign_challenge(
            self.uniffiCloneHandle(),
        FfiConverterData.lower(challenge),$0
    )
})
...
open func supportsExtendedLength() -> Bool  {
    return try!  FfiConverterBool.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_securechannel_supports_extended_length(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func transmit(command: CommandApdu)throws  -> ResponseApdu  {
    ...
    uniffi_openhealth_healthcard_fn_method_securechannel_transmit(
            self.uniffiCloneHandle(),
        FfiConverterTypeCommandApdu_lower(command),$0
    )
})
...
open func unlockEgkWithPuk(puk: CardPin)throws  -> HealthCardResponseStatus  {
    return try  FfiConverterTypeHealthCardResponseStatus_lift(try rustCallWithError(FfiConverterTypeSecureChannelError_lift) {
    uniffi_openhealth_healthcard_fn_method_securechannel_unlock_egk_with_puk(
            self.uniffiCloneHandle(),
...
open func verifyPin(pin: CardPin)throws  -> VerifyPinResult  {
    ...
    uniffi_openhealth_healthcard_fn_method_securechannel_verify_pin(
            self.uniffiCloneHandle(),
 ...
 */
public protocol VecOfU8Protocol: AnyObject, Sendable {
    
    func cloneAsNonzeroizingVec()  -> Data
    
}
/**
 * a wrapped Vec<u8> that might be zeroized (depending on it's configuration)
 */
open class VecOfU8: VecOfU8Protocol, @unchecked Sendable {
    fileprivate let handle: UInt64
...
#endif
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_openhealth_healthcard_fn_clone_vecofu8(self.handle, $0) }
    }
    // No primary constructor declared for this class.

    deinit {
        try! rustCall { uniffi_openhealth_healthcard_fn_free_vecofu8(handle, $0) }
    }

    

    
open func cloneAsNonzeroizingVec() -> Data  {
    return try!  FfiConverterData.lift(try! rustCall() {
    uniffi_openhealth_healthcard_fn_method_vecofu8_clone_as_nonzeroizing_vec(
            self.uniffiCloneHandle(),$0
    )
})
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeVecOfU8: FfiConverter {
    typealias FfiType = UInt64
    typealias SwiftType = VecOfU8

    public static func lift(_ handle: UInt64) throws -> VecOfU8 {
        return VecOfU8(unsafeFromHandle: handle)
    }

    public static func lower(_ value: VecOfU8) -> UInt64 {
        return value.uniffiCloneHandle()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> VecOfU8 {
        let handle: UInt64 = try readInt(&buf)
        return try lift(handle)
    }

    public static func write(_ value: VecOfU8, into buf: inout [UInt8]) {
        writeInt(&buf, lower(value))
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeVecOfU8_lift(_ handle: UInt64) throws -> VecOfU8 {
    return try FfiConverterTypeVecOfU8.lift(handle)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeVecOfU8_lower(_ value: VecOfU8) -> UInt64 {
    return FfiConverterTypeVecOfU8.lower(value)
}
 ...
 */
public enum CardDataError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
...
#if compiler(>=6)
extension CardDataError: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeCardDataError: FfiConverterRustBuffer {
    typealias SwiftType = CardDataError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CardDataError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: CardDataError, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeCardDataError_lift(_ buf: RustBuffer) throws -> CardDataError {
    return try FfiConverterTypeCardDataError.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeCardDataError_lower(_ value: CardDataError) -> RustBuffer {
    return FfiConverterTypeCardDataError.lower(value)
}
 ...
 */
public enum CommandBuilderError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
...
#if compiler(>=6)
extension CommandBuilderError: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeCommandBuilderError: FfiConverterRustBuffer {
    typealias SwiftType = CommandBuilderError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CommandBuilderError {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        ...
        case 2: return .Asn1Encode(
            reason: try FfiConverterString.read(from: &buf)
            )
        case 3: return .Command(
            reason: try FfiConverterString.read(from: &buf)
            )
        case 4: return .PinBlock(
            reason: try FfiConverterString.read(from: &buf)
            )
    ...
    public static func write(_ value: CommandBuilderError, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeCommandBuilderError_lift(_ buf: RustBuffer) throws -> CommandBuilderError {
    return try FfiConverterTypeCommandBuilderError.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeCommandBuilderError_lower(_ value: CommandBuilderError) -> RustBuffer {
    return FfiConverterTypeCommandBuilderError.lower(value)
}
...
public enum PsoAlgorithm: Equatable, Hashable {
    
    /**
     * Algorithm for ECDSA sign/verify operations
     */
    case signVerifyEcdsa
...
#if compiler(>=6)
extension PsoAlgorithm: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypePsoAlgorithm: FfiConverterRustBuffer {
    typealias SwiftType = PsoAlgorithm

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> PsoAlgorithm {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        
        case 1: return .signVerifyEcdsa
        
        default: throw UniffiInternalError.unexpectedEnumCase
        }
    }

    public static func write(_ value: PsoAlgorithm, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypePsoAlgorithm_lift(_ buf: RustBuffer) throws -> PsoAlgorithm {
    return try FfiConverterTypePsoAlgorithm.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypePsoAlgorithm_lower(_ value: PsoAlgorithm) -> RustBuffer {
    return FfiConverterTypePsoAlgorithm.lower(value)
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeListPublicKeyEntry: FfiConverterRustBuffer {
    typealias SwiftType = [ListPublicKeyEntry]
    ...
    public static func write(_ value: [ListPublicKeyEntry], into buf: inout [UInt8]) {
        ...
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeListPublicKeyEntry.write(item, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [ListPublicKeyEntry] {
        let len: Int32 = try readInt(&buf)
        var seq = [ListPublicKeyEntry]()
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeListPublicKeyEntry.read(from: &buf))
        }
        return seq
    }
}
...
public func changePin(session: CardChannel, oldPin: CardPin, newPin: CardPin)throws  -> HealthCardResponseStatus  {
    ...
    uniffi_openhealth_healthcard_fn_func_change_pin(
...
public func changePinWithPuk(session: CardChannel, puk: CardPin, newPin: CardPin)throws  -> HealthCardResponseStatus  {
    return try  FfiConverterTypeHealthCardResponseStatus_lift(try rustCallWithError(FfiConverterTypeExchangeError_lift) {
    uniffi_openhealth_healthcard_fn_func_change_pin_with_puk(
        FfiConverterTypeCardChannel_lower(session),
        FfiConverterTypeCardPin_lower(puk),
        FfiConverterTypeCardPin_lower(newPin),$0
    )
...
public func establishSecureChannel(session: CardChannel, cardAccessNumber: CardAccessNumber)throws  -> SecureChannel  {
    ...
    uniffi_openhealth_healthcard_fn_func_establish_secure_channel(
        FfiConverterTypeCardChannel_lower(session),
...
public func establishSecureChannelWithKeys(session: CardChannel, cardAccessNumber: CardAccessNumber, keys: [String])throws  -> SecureChannel  {
    return try  FfiConverterTypeSecureChannel_lift(try rustCallWithError(FfiConverterTypeSecureChannelError_lift) {
    uniffi_openhealth_healthcard_fn_func_establish_secure_channel_with_keys(
        FfiConverterTypeCardChannel_lower(session),
 ...
 * Returns `length` bytes of random data from the card.
 */
public func getRandom(session: CardChannel, length: Int32)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeExchangeError_lift) {
    uniffi_openhealth_healthcard_fn_func_get_random(
        FfiConverterTypeCardChannel_lower(session),
        FfiConverterInt32.lower(length),$0
    )
})
 ...
 */
public func parseHealthCardVersion2(data: Data)throws  -> HealthCardVersion2  {
    return try  FfiConverterTypeHealthCardVersion2_lift(try rustCallWithError(FfiConverterTypeCardDataError_lift) {
    uniffi_openhealth_healthcard_fn_func_parse_health_card_version2(
        FfiConverterData.lower(data),$0
    )
})
}
 ...
 */
public func parseListPublicKeys(data: Data)throws  -> ListPublicKeys  {
    return try  FfiConverterTypeListPublicKeys_lift(try rustCallWithError(FfiConverterTypeCardDataError_lift) {
    uniffi_openhealth_healthcard_fn_func_parse_list_public_keys(
        FfiConverterData.lower(data),$0
    )
})
}
...
public func readVsd(session: CardChannel)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeExchangeError_lift) {
    uniffi_openhealth_healthcard_fn_func_read_vsd(
        FfiConverterTypeCardChannel_lower(session),$0
    )
})
}
...
public func retrieveCertificate(session: CardChannel)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeExchangeError_lift) {
    uniffi_openhealth_healthcard_fn_func_retrieve_certificate(
        FfiConverterTypeCardChannel_lower(session),$0
    )
})
}
...
public func retrieveCertificateFrom(session: CardChannel, certificate: CertificateFile)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeExchangeError_lift) {
    uniffi_openhealth_healthcard_fn_func_retrieve_certificate_from(
        FfiConverterTypeCardChannel_lower(session),
        FfiConverterTypeCertificateFile_lower(certificate),$0
    )
})
...
public func signChallenge(session: CardChannel, challenge: Data)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeExchangeError_lift) {
    uniffi_openhealth_healthcard_fn_func_sign_challenge(
        FfiConverterTypeCardChannel_lower(session),
        FfiConverterData.lower(challenge),$0
    )
})
...
public func unlockEgkWithPuk(session: CardChannel, puk: CardPin)throws  -> HealthCardResponseStatus  {
    return try  FfiConverterTypeHealthCardResponseStatus_lift(try rustCallWithError(FfiConverterTypeExchangeError_lift) {
    uniffi_openhealth_healthcard_fn_func_unlock_egk_with_puk(
        FfiConverterTypeCardChannel_lower(session),
        FfiConverterTypeCardPin_lower(puk),$0
    )
})
...
public func verifyPin(session: CardChannel, pin: CardPin)throws  -> VerifyPinResult  {
    ...
    uniffi_openhealth_healthcard_fn_func_verify_pin(
        FfiConverterTypeCardChannel_lower(session),
        FfiConverterTypeCardPin_lower(pin),$0
    )
})
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_openhealth_healthcard_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_change_pin() != 64087) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_change_pin_with_puk() != 58393) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_establish_secure_channel() != 834) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_establish_secure_channel_with_keys() != 22326) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_get_random() != 28520) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_parse_health_card_version2() != 27903) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_parse_list_public_keys() != 12183) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_read_vsd() != 57931) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_retrieve_certificate() != 10071) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_retrieve_certificate_from() != 53698) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_sign_challenge() != 50262) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_unlock_egk_with_puk() != 38700) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_func_verify_pin() != 34679) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_cardaccessnumber_digits() != 14696) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_cardchannel_supports_extended_length() != 60990) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_cardchannel_transmit() != 31455) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_commandapdu_to_vec() != 26625) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_healthcardcommand_execute() != 31504) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_healthcardcommand_map_status() != 302) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_healthcardcommand_to_apdu() != 61283) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_healthcardversion2_filling_instructions_atr_version() != 40388) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_healthcardversion2_filling_instructions_environment_settings_version() != 4025) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_healthcardversion2_filling_instructions_gdo_version() != 17032) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_healthcardversion2_filling_instructions_key_info_version() != 1855) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_healthcardversion2_filling_instructions_logging_version() != 46767) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_healthcardversion2_filling_instructions_version() != 57882) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_healthcardversion2_is_health_card_version_21() != 47604) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_healthcardversion2_object_system_version() != 38643) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_healthcardversion2_product_identification_object_system_version() != 48447) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_listpublickeyentry_application_identifier() != 55202) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_listpublickeyentry_key_reference() != 40857) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_listpublickeys_entries() != 32170) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_listpublickeys_key_references_for_application_identifier() != 37685) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_responseapdu_data() != 56790) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_responseapdu_sw() != 32765) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_responseapdu_to_vec() != 63594) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_securechannel_change_pin() != 37765) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_securechannel_change_pin_with_puk() != 1779) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_securechannel_get_random() != 64445) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_securechannel_read_vsd() != 14758) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_securechannel_retrieve_certificate() != 12994) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_securechannel_retrieve_certificate_from() != 34691) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_securechannel_sign_challenge() != 7243) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_securechannel_supports_extended_length() != 12500) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_securechannel_transmit() != 10140) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_securechannel_unlock_egk_with_puk() != 40017) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_securechannel_verify_pin() != 58564) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_method_vecofu8_clone_as_nonzeroizing_vec() != 64895) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_cardaccessnumber_from_digits() != 30005) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_cardpin_from_digits() != 31862) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_commandapdu_from_bytes() != 57785) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_commandapdu_header_only() != 59458) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_commandapdu_with_data() != 53335) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_commandapdu_with_data_and_expect() != 59923) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_commandapdu_with_expect() != 50767) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_change_reference_data() != 40999) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_general_authenticate() != 47641) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_general_authenticate_elc_step2() != 1458) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_general_authenticate_mutual_authentication_step1() != 24166) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_general_authenticate_with_data() != 19391) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_get_pin_status() != 6600) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_get_random_values() != 10210) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_internal_authenticate() != 3803) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_list_public_keys() != 1945) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_manage_sec_env_for_signing() != 27217) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_manage_sec_env_for_verify_certificate() != 57906) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_manage_sec_env_select_private_key() != 1600) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_manage_sec_env_set_signature_key_reference() != 55686) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_manage_sec_env_without_curves() != 59271) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_pso_compute_digital_signature() != 18025) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_pso_compute_digital_signature_cvc() != 46028) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_read() != 28605) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_read_sfi() != 1180) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_read_sfi_with_offset() != 56066) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_read_sfi_with_offset_and_length() != 50097) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_read_with_offset() != 13464) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_read_with_offset_and_length() != 2530) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_reset_retry_counter() != 8650) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_reset_retry_counter_with_new_secret() != 34807) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_select() != 42007) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_select_aid() != 34563) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_select_aid_with_options() != 40741) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_select_fid() != 20548) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_select_fid_with_options() != 25716) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_healthcardcommand_verify_pin() != 40370) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_responseapdu_from_bytes() != 61389) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_openhealth_healthcard_checksum_constructor_responseapdu_from_parts() != 27205) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureOpenhealthHealthcardInitialized() {
