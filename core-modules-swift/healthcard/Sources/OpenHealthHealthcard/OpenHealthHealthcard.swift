...
public struct ResponseApdu: Equatable, Hashable {
    ...
    public init(sw: UInt16, status: HealthCardResponseStatus, data: Data) {
        self.sw = sw
        self.status = status
        self.data = data
    }
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeResponseApdu: FfiConverterRustBuffer {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeResponseApdu_lift(_ buf: RustBuffer) throws -> ResponseApdu {
    return try FfiConverterTypeResponseApdu.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeResponseApdu_lower(_ value: ResponseApdu) -> RustBuffer {
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_healthcard_checksum_func_establish_secure_channel() != 20073) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_healthcard_checksum_method_cardaccessnumber_digits() != 24280) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_healthcard_checksum_method_cardchannel_supports_extended_length() != 26182) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_healthcard_checksum_method_cardchannel_transmit() != 27214) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_healthcard_checksum_method_commandapdu_to_bytes() != 5457) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_healthcard_checksum_method_securechannel_supports_extended_length() != 742) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_healthcard_checksum_method_securechannel_transmit() != 36253) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_healthcard_checksum_constructor_cardaccessnumber_from_digits() != 56632) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_healthcard_checksum_constructor_commandapdu_from_bytes() != 2873) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_healthcard_checksum_constructor_commandapdu_header_only() != 5757) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_healthcard_checksum_constructor_commandapdu_with_data() != 34027) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_healthcard_checksum_constructor_commandapdu_with_data_and_expect() != 55724) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_healthcard_checksum_constructor_commandapdu_with_expect() != 59274) {
        return InitializationResult.apiChecksumMismatch
    }
