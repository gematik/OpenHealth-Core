...
package de.gematik.kmp.healthcard.data

import de.gematik.kmp.healthcard.hexSpaceFormat

private val hexUppercaseFormat =
    HexFormat {
        upperCase = true
    }

fun getExpectedApdu(command: String, value: Boolean?): String {
    return EXPECTED_APDU.find { command in it }!!
        .getValue(command)
...
private val EXPECTED_APDU = listOf(
    // ------------------------------------------------------------------------------------------------------------------------------------------
    // ActivateCommand()
    ...
    mapOf("ACTIVATECOMMAND_APDU-3" to mapOf("apdu-true" to "00442089", "apdu-false" to "00442009")),

    // ActivateCommand(Password password, boolean dfSpecific)
    mapOf("ACTIVATECOMMAND_APDU-4" to mapOf("apdu-true" to "00441081", "apdu-false" to "00441001")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // ActivateRecordCommand(int recordNumber, boolean activateAllRecordsStartingFromRecordNumber)
    mapOf("ACTIVATERECORDCOMMAND_APDU-1" to mapOf("apdu-true" to "00080105", "apdu-false" to "00080104")),

    // ActivateRecordCommand(ShortFileIdentifier sfi, int recordNumber, boolean activateAllRecordsStartingFromRecordNumber)
    mapOf("ACTIVATERECORDCOMMAND_APDU-2" to mapOf("apdu-true" to "000801ED", "apdu-false" to "000801EC")),
    ...
    mapOf("CHANGEREFERENCEDATACOMMAND_APDU-1" to mapOf("apdu-true" to "002401810826123456FFFFFFFF", "apdu-false" to "002401010826123456FFFFFFFF")),

    // ChangeReferenceDataCommand(Password password, boolean dfSpecific, Format2Pin oldSecret, Format2Pin newSecret)
    mapOf("CHANGEREFERENCEDATACOMMAND_APDU-2" to mapOf("apdu-true" to "002400811026123456FFFFFFFF26123456FFFFFFFF", "apdu-false" to "002400011026123456FFFFFFFF26123456FFFFFFFF")),
    ...
    mapOf("DEACTIVATECOMMAND_APDU-2" to mapOf("apdu-true" to "00042089", "apdu-false" to "00042009")),
    ...
    mapOf("DEACTIVATECOMMAND_APDU-4" to mapOf("apdu-true" to "00041081", "apdu-false" to "00041001")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // DeactivateRecordCommand(int recordNumber, boolean deactivateAllRecordsStartingFromRecordNumber)
    mapOf("DEACTIVATERECORDCOMMAND_APDU-1" to mapOf("apdu-true" to "00060105", "apdu-false" to "00060104")),

    // DeactivateRecordCommand(ShortFileIdentifier sfi, int recordNumber, boolean deactivateAllRecordsStartingFromRecordNumber)
    mapOf("DEACTIVATERECORDCOMMAND_APDU-2" to mapOf("apdu-true" to "000601ED", "apdu-false" to "000601EC")),
    ...
    mapOf("DELETECOMMAND_APDU-2" to mapOf("apdu-true" to "00E42089", "apdu-false" to "00E42009")),
    ...
    mapOf("DELETECOMMAND_APDU-4" to mapOf("apdu-true" to "00E41081", "apdu-false" to "00E41001")),
    ...
    mapOf("DISABLEVERIFICATIONREQUIREMENTCOMMAND_APDU-1" to mapOf("apdu-true" to "002600810826123456FFFFFFFF", "apdu-false" to "002600010826123456FFFFFFFF")),

    // DisableVerificationRequirementCommand(Password password, boolean dfSpecific, Format2Pin verificationData)
    mapOf("DISABLEVERIFICATIONREQUIREMENTCOMMAND_APDU-2" to mapOf("apdu-true" to "00260181", "apdu-false" to "00260101")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // EnableVerificationRequirementCommand(Password password, boolean dfSpecifica)
    mapOf("ENABLEVERIFICATIONREQUIREMENTCOMMAND_APDU-1" to mapOf("apdu-true" to "002800810826123456FFFFFFFF", "apdu-false" to "002800010826123456FFFFFFFF")),

    // EnableVerificationRequirementCommand(Password password, boolean dfSpecific, Format2Pin verificationData)
    mapOf("ENABLEVERIFICATIONREQUIREMENTCOMMAND_APDU-2" to mapOf("apdu-true" to "00280181", "apdu-false" to "00280101")),
    ...
    mapOf("EXTERNALMUTUALAUTHENTICATECOMMAND_APDU" to mapOf("apdu-true" to "00820000000001000000", "apdu-false" to "008200000100")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // FingerprintCommand(@NotNull byte[] prefix)
    mapOf("FINGERPRINTCOMMAND_APDU" to mapOf("apdu" to "")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // GenerateAsymmetricKeyPairCommand$GakpUseCase,Key,boolean:
    mapOf("GENERATEASYMMETRICKEYPAIRCOMMAND_APDU" to mapOf("apdu-true" to "0046C089000000", "apdu-false" to "0046C009000000")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // GeneralAuthenticateCommand(boolean):
    mapOf("GENERALAUTHENTICATECOMMAND_APDU-1" to mapOf("apdu-true" to "10860000027C0000", "apdu-false" to "00860000027C0000")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // GeneralAuthenticateCommand(boolean, Pk1Pcd, 1)
    mapOf("GENERALAUTHENTICATECOMMAND_APDU-2" to mapOf("apdu-true" to "10860000047C02810000", "apdu-false" to "00860000047C02810000")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // GeneralAuthenticateCommand(boolean, Pk1Pcd, 3)
    mapOf("GENERALAUTHENTICATECOMMAND_APDU-3" to mapOf("apdu-true" to "10860000047C02830000", "apdu-false" to "00860000047C02830000")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // GeneralAuthenticateCommand(boolean, Pk1Pcd, 5)
    mapOf("GENERALAUTHENTICATECOMMAND_APDU-4" to mapOf("apdu-true" to "10860000877C81848181", "apdu-false" to "00860000877C81848181")),
    ...
    mapOf("GETPINSTATUSCOMMAND_APDU" to mapOf("apdu-true" to "80200081", "apdu-false" to "80200001")),
    ...
    mapOf("LOADAPPLICATIONCOMMAND_APDU" to mapOf("apdu-true" to "10EA00000100", "apdu-false" to "00EA00000100")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // ManageChannelCommand(boolean ifTrueOpenNewChannelElseResetOnApplicationLevel)
    mapOf("MANAGECHANNELCOMMAND_APDU-1" to mapOf("apdu-true" to "0070000001", "apdu-false" to "00704001")),

    // ManageChannelCommand(int logicalChannelNumber, boolean ifTrueCloseChannelElseResetChannel)
    mapOf("MANAGECHANNELCOMMAND_APDU-2" to mapOf("apdu-true" to "01708000", "apdu-false" to "01704000")),
    ...
    mapOf("MANAGESECURITYENVIRONMENTCOMMAND_APDU-3" to mapOf("apdu-true" to "0022C1A406800100830189", "apdu-false" to "0022C1A406800100830109")),

    // ManageSecurityEnvironmentCommand$MseUseCase,de.gematik.ti.healthcardaccess.cardobjects.Key,boolean,byte[],int)
    mapOf("MANAGESECURITYENVIRONMENTCOMMAND_APDU-4" to mapOf("apdu-true" to "0022C1A409800100830189840110", "apdu-false" to "0022C1A409800100830109840110")),
    ...
    mapOf("MANAGESECURITYENVIRONMENTCOMMAND_APDU-5" to mapOf("apdu" to "002281B60A83084445475858830214")),
    ...
    mapOf("MANAGESECURITYENVIRONMENTCOMMAND_APDU-6" to mapOf("apdu" to "002281A406830100800105")),

    // ManageSecurityEnvironmentCommand(de.gematik.ti.healthcardaccess.cardobjects.PsoAlgorithm,byte[])
    mapOf("MANAGESECURITYENVIRONMENTCOMMAND_APDU-7" to mapOf("apdu" to "002241A406830118800105")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // PsoComputeCryptographicChecksum(de.gematik.ti.healthcardaccess.cardobjects.PsoAlgorithm,byte[])
    mapOf("PSOCOMPUTECRYPTOGRAPHICCHECKSUM_APDU" to mapOf("apdu" to "002A8E8000000501090203040000")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // PsoComputeCryptographicChecksum(de.gematik.ti.healthcardaccess.cardobjects.PsoAlgorithm,byte[])
    mapOf("PSOVERIFYCRYPTPGRAPHICCHECKSUMCOMMAND_APDU" to mapOf("apdu" to "002A00A2108004090203048E083AE43D7CC33DD192")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // PsoComputeDigitalSignatureCommand(de.gematik.ti.healthcardaccess.cardobjects.PsoAlgorithm,byte[])
    mapOf("PSOCOMPUTEDIGITALSIGNATURECOMMAND_APDU-1" to mapOf("apdu" to "002A9E9A0000206691A8D098B317D8AAE2256632F294A190F8C775334FC2B5001DE79856A11EF80000")),

    mapOf("PSOCOMPUTEDIGITALSIGNATURECOMMAND_APDU-2" to mapOf("apdu" to "002A9E9A0000206691A8D098B317D8AAE2256632F294A190F8C775334FC2B5001DE79856A11EF80000")),

    mapOf("PSOCOMPUTEDIGITALSIGNATURECOMMAND_APDU-3" to mapOf("apdu" to "002A9E9A0000333031300D0609608648016503040201050004206691A8D098B317D8AAE2256632F294A190F8C775334FC2B5001DE79856A11EF80000")),

    mapOf("PSOCOMPUTEDIGITALSIGNATURECOMMAND_APDU-4" to mapOf("apdu" to "002A9E9A0000333031300D0609608648016503040201050004206691A8D098B317D8AAE2256632F294A190F8C775334FC2B5001DE79856A11EF80000")),
    ...
    // ------------------------------------------------------------------------------------------------------------------------------------------
    mapOf("PSOENCIPHER_APDU-1" to mapOf("apdu" to "")),

    mapOf("PSOENCIPHER_APDU-2" to mapOf("apdu" to "002A868000005DA05B80010B06092B24030302080101077F49438641047768387A5191CDF07F9BCCB0A627A889BB712CF5711A5932613AE693F52BB831368B1B6AD0EB5671FE1AF0BE188C2A05F7B09173791BC99F3A495933FFE08A348005ABCE4412340000")),

    mapOf("PSOENCIPHER_APDU-3" to mapOf("apdu" to "002A8680000005ABCE4412340000")),

    mapOf("PSOENCIPHER_APDU-4" to mapOf("apdu" to "")),

    // ------------------------------------------------------------------------------------------------------------------------------------------
    // PsoVerifyDigitalSignatureCommand(java.security.interfaces.ECPublicKey,byte[],byte[])
    mapOf("PSOVERIFYCERTIFICATECOMMAND_APDU" to mapOf("apdu" to "")),
    ...
    mapOf("PSOVERIFYDIGITALSIGNATURECOMMAND_APDU" to mapOf("apdu" to "")),
    ...
    mapOf("SELECTCOMMAND_APDU-1" to mapOf("apdu-false-false" to "00A4040C", "apdu-true-false" to "00A4030C", "apdu-false-true" to "00A40404000000", "apdu-true-true" to "00A40304000000")),
    ...
    mapOf("SELECTCOMMAND_APDU-4" to mapOf("apdu-true" to "00A4010C022F01", "apdu-false" to "00A4020C022F01")),

    // SelectCommand(ApplicationIdentifier aid, boolean selectNextElseFirstOccurrence, boolean requestFcp, int fcpLength)
    mapOf("SELECTCOMMAND_APDU-3" to mapOf("apdu-true-true" to "00A4040606D2760000010264", "apdu-true-false" to "00A4040E06D27600000102", "apdu-false-true" to "00A4040406D2760000010264", "apdu-false-false" to "00A4040C06D27600000102")),

    // SelectCommand(FileIdentifier fid, boolean selectNextElseFirstOccurrence, boolean requestFcp, int fcpLength)
    mapOf("SELECTCOMMAND_APDU-5" to mapOf("apdu-true-true" to "00A40104022F0164", "apdu-true-false" to "00A4010C022F01", "apdu-false-true" to "00A40204022F0164", "apdu-false-false" to "00A4020C022F01")),
    ...
    // .Key,boolean)
    mapOf("TERMINATECOMMAND_APDU-2" to mapOf("apdu-true" to "00E82089", "apdu-false" to "00E82009")),

    // byte[]
    mapOf("TERMINATECOMMAND_APDU-3" to mapOf("apdu" to "00E8210003830100")),

    // Password,boolean
    mapOf("TERMINATECOMMAND_APDU-4" to mapOf("apdu-true" to "00E81081", "apdu-false" to "00E81001")),
    ...
    mapOf("VERITYCOMMAND_APDU" to mapOf("apdu-true" to "002000810826123456FFFFFFFF", "apdu-false" to "002000010826123456FFFFFFFF")),
