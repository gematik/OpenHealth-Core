...
interface SmartCard {
     ...
     */
    suspend fun <T> connect(block: CommunicationScope.() -> T): T

    /**
     * The default implementation for communicating with a smart cards using the APDU protocol.
     */
    companion object Default : SmartCard by defaultPlatformSmartCard()
}

/**
 * Provides the default platform-specific implementation of the SmartCard interface.
 *
 * @return The platform-specific implementation of the SmartCard interface.
 */
internal fun defaultPlatformSmartCard(): SmartCard = TODO()