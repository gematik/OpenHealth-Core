...
fun ICardChannel.unlockEgk(
    ...
    val response =
        if (unlockMethod ==
            de.gematik.ti.healthcard.model.command.UnlockMethod.ChangeReferenceData.name
        ) {
            de.gematik.ti.healthcard.model.command.HealthCardCommand
                .changeReferenceData(
                    passwordReference = passwordReference,
            ...
            de.gematik.ti.healthcard.model.command.HealthCardCommand
                .unlockEgk(
                    ...
                    newSecret =
                        if (unlockMethod ==
                            de.gematik.ti.healthcard.model.command.UnlockMethod.ResetRetryCounterWithNewSecret.name
                        ) {
