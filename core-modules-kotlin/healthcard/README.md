...
# arch: x86_64 | aarch64
just kotlin-bindings-generate healthcard darwin aarch64 libopenhealth_healthcard.dylib
```
...
just kotlin-bindings-generate healthcard linux x86_64 libopenhealth_healthcard.so
```

- Pick a different profile (default is `release`):

```bash
just kotlin-bindings-generate healthcard linux x86_64 libopenhealth_healthcard.so debug
```
...
kotlin-bindings-generate healthcard windows x86_64 openhealth_healthcard.dll
```
